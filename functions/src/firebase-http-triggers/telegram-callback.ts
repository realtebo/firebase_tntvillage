    ...
    switch (text) {
        case '/refresh': {
            ...
            if (id !== MIRKO) {
                ...
                await sendTo(id, "Spiacente " + first_name + " " + last_name + ", solo alcuni utenti posso eseguire questo comando");
                return;
            }
        ...
        default: {
            ...
            await sendTo(id, "Spiacente " + first_name + " " + last_name + ", questo è un bot privato!");
        }
    }
}
